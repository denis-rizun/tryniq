...
export const NotesPanel = ({
  ...
  return (
    <div className="overview-right scroll-y">
      ...
      <div className="notes-meta-row mono">
        generated by {meeting.llmModel} · last updated 2s ago
      </div>
      ...
      <NotesSection label="RELATED PAST MEETINGS" defaultCollapsed>
        <div className="note-item" style={{ borderLeft: 'none', paddingLeft: 0 }}>
          <span className="mono" style={{ fontSize: 11, color: 'var(--color-ink-tertiary)' }}>
            {meeting.previousMeeting.date}
          </span>
          <span style={{ marginLeft: 8 }}>
            ...
            >
              {meeting.previousMeeting.title}
            </button>
          </span>
          <div style={{ fontSize: 12, color: 'var(--color-ink-secondary)', marginTop: 2 }}>
            Linked topics: {meeting.previousMeeting.relatedTopics.join(', ')}
          </div>
        </div>
      </NotesSection>
    </div>
